...
[Script]
oilPrice = type=generic,timeout=5,script-path=https://raw.githubusercontent.com/Keywos/rule/main/JS/yj.js,argument=shanxi-3/xian
*/

const input = $argument || $persistentStore.read("oilPrice")||"title=实时油价信息&location=fujian/fuzhou&type=92,95&isFriendlyTips=true"
            	...
            	types.forEach((param)=>{
            		switch (param) {
									case "92":
										...
										break;
									case "95":
										content.push(`${prices[1].name} ${prices[0].value}`);
										break;
									case "98":
